...
export function generateResourceSchema(resource: Resource, baseUrl = "https://freeinternetstuff.net") {
  return {
...
export function generateCollectionSchema(collection: Collection, resources: Resource[], baseUrl = "https://freeinternetstuff.net") {
  return {
    "@context": "https://schema.org",
    "@type": "ItemList",
...
export function generateCategorySchema(category: Category, resourceCount: number, baseUrl = "https://freeinternetstuff.net") {
  return {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
...
export function generateWebSiteSchema(baseUrl = "https://freeinternetstuff.net") {
  return {
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "FreeInternetStuff",
    url: baseUrl,
    potentialAction: {
      "@type": "SearchAction",
